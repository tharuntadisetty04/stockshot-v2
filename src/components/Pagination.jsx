    ...
    return (
        <div className='my-4'>
            <div className='flex'>
                ...
                <button className='rounded-r-md bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 font-semibold ' onClick={() => setPage(5)} disabled={currentPage === totalPages}>3</button>
            </div>
        </div>
    );
};
